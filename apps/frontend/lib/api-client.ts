...
export class ApiClient {
  ...
  private async request<T>(
    ...
    try {
      ...
      if (!response.ok) {
        ...
        // Create error with parsed data if available
  ...
  async getCommunityPreviewBySlug(
    slug: string
  ...
  async checkCommunityMembership(
    communityId: string
  ): Promise<ApiResponse<{ isMember: boolean; role?: string }>> {
    return this.request<ApiResponse<{ isMember: boolean; role?: string }>>(
  ...
  async getCourseModules(
    ...
    return this.request<PaginatedResponse<CourseModule>>(
      `/courses/${courseId}/modules?${params}`
    )
  }
  ...
  async createCourseModule(
    ...
    return this.request<ApiResponse<CourseModule>>(
  ...
  async getCourseMaterials(
    ...
    return this.request<PaginatedResponse<CourseMaterial>>(
      `/courses/modules/${moduleId}/materials?${params}`
    )
  }
  ...
  async createCourseMaterial(
    ...
    return this.request<ApiResponse<CourseMaterial>>(
      `/courses/modules/${data.moduleId}/materials`,
      {
        method: "POST",
        body: JSON.stringify(data),
      }
  ...
  async getCommunityLeaderboard(
    ...
    return this.request<PaginatedResponse<LeaderboardEntry>>(
      `/scoreboard/communities/${communityId}/leaderboard?${params}`
    )
  }
  ...
  async getCourseLeaderboard(
    ...
    return this.request<PaginatedResponse<LeaderboardEntry>>(
      `/scoreboard/courses/${courseId}/leaderboard?${params}`
    )
  }
  ...
  async togglePinPost(id: string): Promise<ApiResponse<{ isPinned: boolean }>> {
    return this.request<ApiResponse<{ isPinned: boolean }>>(
      `/posts/${id}/pin`,
      {
        method: "POST",
      }
  ...
  async toggleFeaturePost(
    id: string
  ): Promise<ApiResponse<{ isFeatured: boolean }>> {
    return this.request<ApiResponse<{ isFeatured: boolean }>>(
      `/posts/${id}/feature`,
      {
        method: "POST",
      }
  ...
  async getFeaturedCommunityPosts(
    communityId: string,
    page = 1,
    pageSize = 10
  ): Promise<PostListResponse> {
    ...
    return this.request<PostListResponse>(
      `/communities/${communityId}/posts/featured?${params}`
    )
  }

  async getPinnedCommunityPosts(
    communityId: string,
    page = 1,
    pageSize = 10
  ): Promise<PostListResponse> {
    ...
    return this.request<PostListResponse>(
      `/communities/${communityId}/posts/pinned?${params}`
    )
  }
  ...
  async getCommunityAnnouncements(
    ...
    return this.request<PostListResponse>(
      `/communities/${communityId}/posts/announcements?${params}`
    )
  }
