...
export interface UpdateCommunityRequest
  extends Partial<CreateCommunityRequest> {
  id: string
  avatar?: string
...
export interface UpdateCourseModuleRequest
  extends Partial<CreateCourseModuleRequest> {
  id: string
}
...
export interface Post {
  id: string
  title: string
  content: string | null // Can be null when user is not a member and post is community view only
  excerpt?: string | null // Can be null when user is not a member and post is community view only
  slug?: string
